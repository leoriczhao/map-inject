// DisplayChat.cpp — EXDisplayChat native
// Ported from YDWE yd_jass_api/DisplayChat.cpp
// Sends a chat message to a specific player via the InGameChatWhat function.
...
static uintptr_t searchInGameChatWhat()
{
	//=========================================
	// (1)
	//
