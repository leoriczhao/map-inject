// ItemState.cpp — EX* item data natives
// Ported from YDWE yd_jass_api/ItemState.cpp
// Provides EXGetItemDataString and EXSetItemDataString for reading/writing
// item UI data (art, tip, ubertip, name, description).
