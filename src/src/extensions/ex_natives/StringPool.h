...
// StringPool — Pooled allocator for game string memory.
// Ported from YDWE yd_jass_api/StringPool.h.
// Avoids memory leaks when replacing game strings by recycling fixed-size buffers.
